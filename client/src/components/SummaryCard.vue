 <template>
  <div
    class="summary-card bg-white rounded-lg outline-none"
    :class="{
  ...
  >
    ...
    <div class="card-footer-container h-14 flex items-end">
      ...
      >
        <button
          class="left flex items-center bg-red-300 rounded px-2 py-1 text-white opacity-30 hover:opacity-80"
        ...
        <button
          class="right flex items-center bg-green-500 rounded px-2 py-1 text-white opacity-50 hover:opacity-80"
        ...
        >
          ...
          <span class="ml-0.5 text-xs">Finish</span>
        </button>
      </div>
    </div>
  </div>

    ...
    >
      ...
      <div>
        <div class="mb-6 flex justify-center">
          <button
            class="p-2 rounded-l-md hover:bg-gray-500 hover:text-white"
            :class="{
              'bg-gray-500 text-white': showContent === 'category',
          ...
          <button
            class="p-2 hover:bg-gray-500 hover:text-white"
            :class="{
              'bg-gray-500 text-white': showContent === 'description',
          ...
          <button
            class="p-2 rounded-r-md hover:bg-gray-500 hover:text-white"
            :class="{
              'bg-gray-500 text-white': showContent === 'review',
